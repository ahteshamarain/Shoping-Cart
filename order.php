...
?>
	...
	<div class="cart-section mt-150 mb-150">
		<div class="container">
			...
			<a href="shop.php" class="boxed-btn mb-5">View shop</a>
			</div>
			...
			$data = "SELECT * FROM `checkout` WHERE `user_id` = '$user_id' AND `status` = 1";
...
<td>
    <a href="status.php?pid=<?php echo $row['id']; ?>">
        <button class="product-total btn btn-primary">Cancel order</button>
    </a>
</td>
